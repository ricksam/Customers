...
namespace RckPDV
{
  public partial class frmBase : Form
  {
    ...
    private void frmBase_Load(object sender, EventArgs e)
    {
      ...
      this.btnWindowClose.BackgroundImage = global::RckPDV.Properties.Resources.CLOSE;
      this.btnWindowMinimize.BackgroundImage = global::RckPDV.Properties.Resources.MINIMIZE;
    ...
    private void btn_MouseHover(object sender, EventArgs e)
    {
      ...
      {
        ((Button)sender).Image = global::RckPDV.Properties.Resources.BUTTONGLASS;
      }
    }

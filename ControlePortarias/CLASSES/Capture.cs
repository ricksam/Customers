...
namespace DirectShowLib
{
  ...
  internal class Capture : ISampleGrabberCB, IDisposable
  {
    ...
    #region public Capture(int iDeviceNum, int iWidth, int iHeight, short iBPP, Control hControl)
    ...
    #region private void SetupGraph(DsDevice dev, int iWidth, int iHeight, short iBPP, Control hControl)
    ...
    #region private void SaveSizeInfo(ISampleGrabber sampGrabber)
    ...
    #region private void ConfigVideoWindow(Control hControl)
    ...
    #region private void ConfigureSampleGrabber(ISampleGrabber sampGrabber)
    ...
    #region private void SetConfigParms(IPin pStill, int iWidth, int iHeight, short iBPP)
    ...
    #region private void CloseInterfaces()
    ...
    #region int ISampleGrabberCB.SampleCB(double SampleTime, IMediaSample pSample)
    ...
    #region int ISampleGrabberCB.BufferCB(double SampleTime, IntPtr pBuffer, int BufferLen)
    ...
    #region public Bitmap GetCurrentImage()
    public Bitmap GetCurrentImage()
    {
      IntPtr m_ip = Click();
      Bitmap b = new Bitmap(Width, Height, Stride, System.Drawing.Imaging.PixelFormat.Format24bppRgb, m_ip);
      b.RotateFlip(RotateFlipType.RotateNoneFlipY);
      return b;
    }
    #endregion

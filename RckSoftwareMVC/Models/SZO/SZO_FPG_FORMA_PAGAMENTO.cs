...
namespace SysZoo
{
  ...
  public class dsSZO_FPG_FORMA_PAGAMENTO : DefaultDataSource<SZO_FPG_FORMA_PAGAMENTO>
  {
    ...
    public SZO_FPG_FORMA_PAGAMENTO Get_FromMD5(string FPG_MD5)
    {
      return Get("SELECT * FROM SZO_FPG_FORMA_PAGAMENTO WHERE FPG_MD5 = " + DbQuoted(FPG_MD5));
    }
    ...
    public void Save(SZO_FPG_FORMA_PAGAMENTO tab, System.Data.Common.DbTransaction transaction = null)
    {
      ...
      if (tab.FPG_CODIGO == 0)
      {
        ...
        { tab.FPG_MD5 = lib.Class.Encryption.getMD5Hash(Guid.NewGuid().ToString()); }

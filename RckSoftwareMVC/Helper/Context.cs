...
namespace RckSoftware
{
    public class Context : IDisposable
    {
        ...
        public Context()
        {
            if (_conn == null)
            {
                _conn = new System.Data.SqlClient.SqlConnection(@"Data Source=rcksoftware.cbmmxoygefmo.us-east-2.rds.amazonaws.com;Initial Catalog=syscam;Persist Security Info=True;User ID=admin;Password=RCK6px2erjr;Encrypt=False;TrustServerCertificate=True");

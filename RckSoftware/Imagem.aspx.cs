...
namespace RckSoftware
{
  public partial class Imagem : System.Web.UI.Page
  {
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (imgs.Length != 0)
      {
        lib.Class.EncryptionDeprecated enc = new lib.Class.EncryptionDeprecated(Request["authenticate"], "/9j4AQSkZJRgBEYD2wOxIPXFhHzMc8tLyUTldvWob3pm+naVfCG1K0iN6qe5r7us=");
